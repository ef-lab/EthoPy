...
class Welcome:
    ...
    def start(self):
        ...
        self.screen.add_button(name='Start experiment', action=self.start_experiment, x=250, y=300, w=100, h=100, color=(0, 128, 0))
    ...
    def change_animal(self):
        ...
        screen.add_numpad()
        button = screen.add_button(name='OK', x=100, y=300, w=100, h=100, color=(0, 128, 0))
