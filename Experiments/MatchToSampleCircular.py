...
class Experiment(State, ExperimentClass):
    ...
    def setup(self,logger, MultiPort, session_params):
        ExperimentClass.setup(self, logger, MultiPort, session_params)
        self.transition_cond.transition_method = self.circular
    ...
    def circular(self, criterion_result, cur_dif, difs):
        ...
        if criterion_result>self.transition_cond.block_upgrade:
            cur_dif = (self.transition_cond.succeed_block(cur_dif, "Upgrade")) % difs_size
        return cur_dif
